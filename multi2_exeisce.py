...
# ----------------------設定-------------------------
SLCdatapath = '/media/alt41450/SAR/tw/slc'  #影像資料路徑
...
for i,j in zip(range(len(date2_uni)),date2_uni):
    ...
    change_node_text(text_nodes, "%s/%s,%s/%s" %(ASFdatapath,dict_one2all2[j][0],ASFdatapath,dict_one2all2[j][1]))
    ...
    change_node_text(text_nodes2, "%s/%s,%s/%s" %(ASFdatapath,dict_one2all1[j][0],ASFdatapath,dict_one2all1[j][1]))
